...
import { removeFavorite } from "@/shared/ui/Favorites/model/favoritesSlice";
import { useNavigate } from "react-router-dom";
import { MovieForSlice } from "@/features/movie/MovieDetails/interface";
import { Favorite } from "@/shared/ui/Favorites/interface";

const Favorites = ({ handleClose }: { handleClose: () => void }) => {
  const dispatch = useAppDispatch();
  const favorites = useAppSelector(
    (state: { favorites: { favorites: Favorite[] } }) =>
